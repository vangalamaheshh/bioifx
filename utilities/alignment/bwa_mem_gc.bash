...
NS500_DIR="/zfs/cores/mbcf/mbcf-storage/MiSeq/analysis/161004_M00851_0103_000000000-ARU6N_RK3482"
...
for left_mate in $(find ${NS500_DIR}/data/ -type l -name "[0-9]*_R1_*fastq.gz"); do
	...
	picard CollectGcBiasMetrics I=${OUT_DIR}/${out_token}/${out_token}.sorted.bam O=${OUT_DIR}/${out_token}/${out_token}.picard.gc_bias_metrics.txt CHART=${OUT_DIR}/${out_token}/${out_token}.picard.gc_bias_metrics.pdf S=${OUT_DIR}/${out_token}/${out_token}.picard.summary_metrics.txt R=/zfs/cores/mbcf/mbcf-storage/devel/umv/ref_files/human/Homo_sapiens/UCSC/hg19/Sequence/WholeGenomeFasta/genome.fa &
done
