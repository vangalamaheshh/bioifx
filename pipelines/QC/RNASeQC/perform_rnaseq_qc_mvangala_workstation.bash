...
if [[ $(hostname) =~ Neo ]]; then
	...
	RNASEQC_EXEC="/media/mvangala/data/software/bioinfo/QC/RNA-SeQC/RNA-SeQC_v1.1.7.jar"
	BWA_EXEC="/media/mvangala/data/software/bioinfo/alignment/BWA/bwa/bwa"

elif [[ ! $(hostname) =~ ^n[0-9]+$ ]]; then
		JAVA_EXEC="/ifs/rcgroups/mbcf/umv/software/jdk1.8.0_45/bin/java"
                SAMTOOLS="/usr/bin/samtools"
		RNASEQC_EXEC="/ifs/rcgroups/mbcf/umv/software/RNA-SeQC_v1.1.8.jar"
		BWA_EXEC="/ifs/rcgroups/mbcf/umv/software/bwa/bwa"
else [ -e "/usr/local/bin/java" ];
                JAVA_EXEC="/usr/local/bin/java"
                SAMTOOLS="/usr/local/bin/samtools"
		RNASEQC_EXEC="/zfs/cores/mbcf/mbcf-storage/devel/umv/software/RNA-seq-QC/RNA-SeQC_v1.1.8.jar"
		BWA_EXEC="/zfs/cores/mbcf/mbcf-storage/devel/umv/software/bwa-0.7.12/bwa"
fi
...
if [  $MOUSE ]; then
	...
	rRNA_ref_fasta="/media/mvangala/mbcf_storage_aberdeen/ref_files/mouse/Mus_musculus/UCSC/mm9/Sequence/WholeGenomeFasta/mouse_all_rRNA_sequences.fa"
	ref_fasta="/media/mvangala/mbcf_storage_aberdeen/ref_files/mouse/Mus_musculus/UCSC/mm9/Sequence/WholeGenomeFasta/genome.fa"
	gtf_file="/media/mvangala/mbcf_storage_aberdeen/ref_files/mouse/Mus_musculus/UCSC/mm9/Annotation/Genes/genes.gtf"
elif [ $HUMAN ]; then
