...
for left_file in $(find /media/mvangala/Louissaint -name "05*R1*fastq"); do 
...
#	sample_base_dir="${sample_base_dir}/${sample_name}"
	...
	process_picard "${ANALYSIS_DIR}/${sample_base_dir}/2pass" "${ANALYSIS_DIR}/${sample_base_dir}/picard" $sample_name
