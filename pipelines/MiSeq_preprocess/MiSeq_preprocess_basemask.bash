...
#$ -cwd
#$ -N MiSeq_preprocess
#$ -e /zfs/cores/mbcf/mbcf-storage/devel/umv/LOGS/MiSeq_preprocess.log
#$ -o /zfs/cores/mbcf/mbcf-storage/devel/umv/LOGS/MiSeq_preprocess.out
		...
		if [ -e "${DEST_DIR}/${dir}" ]; then
			...
			if [ -e "${SOURCE_DIR}/${dir}/$RUN_COMPLETION_TOKEN1" ] && [ -e "${SOURCE_DIR}/${dir}/$RUN_COMPLETION_TOKEN2" ]; then
				...
				if [ -e "${DEST_DIR}/${dir}/bcl2fastq" ] || [ -e "${DEST_DIR}/${dir}_${ILAB_ID}/bcl2fastq" ]; then
                    ...
                    BASE_MASK_INFO="I6Y*,Y*"
					#MISMATCHES=$(${PYTHON3} $MISMATCHES_SCRIPT --file "${SOURCE_DIR}/${dir}/$RUN_COMPLETION_TOKEN2")
					MISMATCHES=1
				...
				if [ -e "${DEST_DIR}/${dir}/concat_per_sample_fastq" ] || [ -e "${DEST_DIR}/${dir}_${ILAB_ID}/concat_per_sample_fastq" ]; then
					...
					#send mail
					cat > ${MAIL_DIR}/${dir}.MS.mail <<_EOF
MiSeq Run: '${dir}' Status: Completed
Run Type: MiSeq
Run_Name: ${dir}
...
_EOF
				...
				if [ -e "${DEST_DIR}/${dir}/fastqc/before_filtering" ] || [ -e "${DEST_DIR}/${dir}_${ILAB_ID}/fastqc/before_filtering" ]; then
                    ...
                    /zfs/cores/mbcf/mbcf-storage/devel/umv/software/miniconda3/bin/Rscript ${FASTQC_PLOT} "${DEST_DIR}/${dir}_${ILAB_ID}/fastqc/fastqc_matrix_bf.csv" "${DEST_DIR}/${dir}_${ILAB_ID}/fastqc/fastqc_matrix_bf.png"
...
SOURCE_DIR="/zfs/cores/mbcf/mbcf-storage/MiSeq/rawdata"
DEST_DIR="/zfs/cores/mbcf/mbcf-storage/MiSeq/analysis"

PYTHON3="/zfs/cores/mbcf/mbcf-storage/devel/umv/software/Python-3.4.1/bin/python3"
MISMATCHES_SCRIPT="/zfs/cores/mbcf/mbcf-storage/devel/umv/ROOT/bioifx/utilities/math/is_dup_combo.py"

TRANSFER_TO="/zfs/cores/mbcf/mbcf-storage/TempTransfer/MiSeq"
