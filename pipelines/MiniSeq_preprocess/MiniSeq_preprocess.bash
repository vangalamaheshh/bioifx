...
#$ -cwd
#$ -N MiniSeq_preprocess
#$ -e /zfs/cores/mbcf/mbcf-storage/devel/umv/LOGS/MiniSeq_preprocess.log
#$ -o /zfs/cores/mbcf/mbcf-storage/devel/umv/LOGS/MiniSeq_preprocess.out
		...
		if [ -e "${DEST_DIR}/${dir}" ]; then
			...
			if [ -e "${SOURCE_DIR}/${dir}/$RUN_COMPLETION_TOKEN1" ] && [ -e "${SOURCE_DIR}/${dir}/$RUN_COMPLETION_TOKEN2" ]; then
				...
				if [ -e "${DEST_DIR}/${dir}/concat_per_sample_fastq" ] || [ -e "${DEST_DIR}/${dir}_${ILAB_ID}/concat_per_sample_fastq" ]; then
					...
					#send mail
					cat > ${MAIL_DIR}/${dir}.MiniSeq.mail <<_EOF
...
SOURCE_DIR="/zfs/cores/mbcf/mbcf-storage/MiniSeq/rawdata"
DEST_DIR="/zfs/cores/mbcf/mbcf-storage/MiniSeq/analysis"
...
TRANSFER_TO="/zfs/cores/mbcf/mbcf-storage/TempTransfer/MiniSeq"
